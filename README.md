...
- 支持 `read_file`、`write_file`、`edit_file`、`append_file`、`create_dir`、`copy_path`、`move_path`、`delete_path`、`file_info`、`bash`、`execute_code`、`run_program`、`glob_search`、`grep_search`、`code_index`、`git_manager`、`test_loop`、`list_dir`、`ask_user`、`choose_option`、`list_models`、`list_skills`、`read_skill`、`list_mcp_servers`、`call_mcp_tool`、`mcp_resource`、`mcp_prompt`、`manage_todos`、`system_control`、`call_model`。
